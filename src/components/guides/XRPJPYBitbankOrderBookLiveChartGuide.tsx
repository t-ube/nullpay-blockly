...
export default function XRPJPYBitbankOrderBookLiveChartGuide({ onBlockSelectedV2, onClose }: IGuideProps) {
  useWorkspaceManager(workspaces, onBlockSelectedV2, onClose);

  return (
    <Box>
      <Typography variant="h4">XRP/JPY Order Book Live Chart (bitbank)</Typography>
